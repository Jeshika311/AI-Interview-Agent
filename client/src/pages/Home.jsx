  ...
  return (
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className='ma-w-6xl mx-auto'>
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
              <HiSparkles size={18} className='text-green-600 bg-green-50'/>
              ...
              <div className='grid md:grid-cols-2 gap-10'>
                {
                  [
                    ...
                    },
                    {
                      ...
                      desc: "Detailed strengths, weaknesses and improvement areas."
                    },
                    {
                      image: analyticsImg,
                      icon: <BsBarChart size={24} />,
                    ...
                    className='bg-white border border-gray-200 rounded-3xl shadow-sm p-8 hover:shadow-xl transition-all'>
                      <div className='flex flex-col md:flex-row items-center gap-8'>
                        <div className='w-full md:w-1/2 flex justify-center'>
                          <img src={item.image} alt={item.title} className='w-full h-full object-contain max-h-64' />
                        </div>
              ...
              <div className='grid md:grid-cols-2 gap-10'>
                {
                  [
                    ...
                    },
                    {
                      ...
                      desc: "Deep technical questioning based on selected roles."
                    },
                    {
                      image: confidenceImg,
