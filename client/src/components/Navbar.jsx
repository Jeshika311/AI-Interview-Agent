      ...
      >
        ...
        <div className='flex items-center gap-6 relative'>
          ...
          <div className='relative'>
            ...
            {showCreditPopup && (
              <div className='absolute right-[-50] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50'>
          ...
          <div className='relative'>
            <button onClick={() => {
              ...
              {userData ? userData?.user?.name?.slice(0, 1).toUpperCase() :
            ...
            {showUserPopup && (
              <div className='absolute right-0 mt-3 w-48 bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
                <p className='text-md text-blue-500 font-medium mb-1'>
                  {userData ? userData?.user?.name : "Guest User"}              
                </p>
