...
const Step1SetUp = ({onStart}) => {
  ...
  const handleStart = async () => {
    ...
    try {
      ...
      console.log("Interview started:", result.data);
        ...
        className='p-12 bg-white'>
          ...
          <div className='space-y-6'>
            ...
            {!analysisDone && (
              ...
              className='border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:bg-green-50 hover:border-green-500 transition'>
                  ...
                  {skills.length > 0 && (
                    <div>
                      ...
                      <div className='flex flex-wrap gap-2 '>
                        {skills.map((s, i) => (
                          <span className='bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm' key={i}>
                            {s}
                          </span>
                        ))}
                      </div>
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className='w-full disabled:bg-green-600 bg-green-600 hover:bg-green-700 text-white py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md'>
